...
Kplusfilter = cms.EDFilter("PythiaDauVFilter",
    MotherID        = cms.untracked.int32(10551),
...
Kminusfilter = cms.EDFilter("PythiaDauVFilter",
    MotherID        = cms.untracked.int32(10551),
    ParticleID      = cms.untracked.int32(333),
    NumberDaughters = cms.untracked.int32(1),
    DaughterIDs     = cms.untracked.vint32(-321),
...
ProductionFilterSequence = cms.Sequence(generator*pwaveIDfilter*decayfilter*upsfilter*Kplusfilter*Kminusfilter)
